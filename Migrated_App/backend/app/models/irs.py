...
"""
from sqlalchemy import Column, Integer, String, Date, DateTime, Text, Boolean, ForeignKey, Numeric
...
class IrsTransactionRec(Base):
    ...
    trans_amount = Column(Numeric(15, 2), nullable=False)
    ...
    trans_deductible_amount = Column(Numeric(15, 2), default=0)
...
class IrsBankReconciliationRec(Base):
    ...
    recon_statement_balance = Column(Numeric(15, 2), nullable=False)
    recon_book_balance = Column(Numeric(15, 2), nullable=False)
    recon_outstanding_checks = Column(Numeric(15, 2), default=0)
    recon_deposits_in_transit = Column(Numeric(15, 2), default=0)
    recon_bank_charges = Column(Numeric(15, 2), default=0)
    recon_interest_earned = Column(Numeric(15, 2), default=0)
    recon_nsf_items = Column(Numeric(15, 2), default=0)
    recon_other_adjustments = Column(Numeric(15, 2), default=0)
    recon_reconciled_balance = Column(Numeric(15, 2), nullable=False)
...
class IrsTaxCalculationRec(Base):
    ...
    calc_gross_income = Column(Numeric(15, 2), default=0)
    calc_total_deductions = Column(Numeric(15, 2), default=0)
    calc_taxable_income = Column(Numeric(15, 2), default=0)
    calc_federal_tax = Column(Numeric(15, 2), default=0)
    calc_state_tax = Column(Numeric(15, 2), default=0)
    calc_alternative_minimum_tax = Column(Numeric(15, 2), default=0)
    calc_self_employment_tax = Column(Numeric(15, 2), default=0)
    calc_estimated_tax_payments = Column(Numeric(15, 2), default=0)
    calc_withholding_tax = Column(Numeric(15, 2), default=0)
    calc_credits = Column(Numeric(15, 2), default=0)
    calc_penalties = Column(Numeric(15, 2), default=0)
    calc_interest = Column(Numeric(15, 2), default=0)
    calc_refund_due = Column(Numeric(15, 2), default=0)
    calc_tax_due = Column(Numeric(15, 2), default=0)
    calc_effective_rate = Column(Numeric(5, 2), default=0)
    calc_marginal_rate = Column(Numeric(5, 2), default=0)
...
class IrsTaxTableRec(Base):
    ...
    table_income_min = Column(Numeric(15, 2), nullable=False)
    table_income_max = Column(Numeric(15, 2), nullable=False)
    table_tax_base = Column(Numeric(15, 2), default=0)
    table_tax_rate = Column(Numeric(5, 4), nullable=False)
    table_bracket_number = Column(Integer, nullable=False)
    table_standard_deduction = Column(Numeric(15, 2), default=0)
    table_personal_exemption = Column(Numeric(15, 2), default=0)
...
class IrsTaxReturnRec(Base):
    ...
    return_gross_receipts = Column(Numeric(15, 2), default=0)
    return_total_income = Column(Numeric(15, 2), default=0)
    return_total_deductions = Column(Numeric(15, 2), default=0)
    return_taxable_income = Column(Numeric(15, 2), default=0)
    return_total_tax = Column(Numeric(15, 2), default=0)
    return_total_payments = Column(Numeric(15, 2), default=0)
    return_refund_amount = Column(Numeric(15, 2), default=0)
    return_balance_due = Column(Numeric(15, 2), default=0)
...
class IrsScheduleRec(Base):
    ...
    schedule_return_id = Column(Integer, ForeignKey('acas.irs_tax_return_rec.return_id'), nullable=False, index=True)
    ...
    schedule_amount = Column(Numeric(15, 2), default=0)
    schedule_percentage = Column(Numeric(5, 2), default=0)
    schedule_carryover_amount = Column(Numeric(15, 2), default=0)
    schedule_prior_year_amount = Column(Numeric(15, 2), default=0)
...
class IrsEstimatedPaymentRec(Base):
    ...
    payment_paid_amount = Column(Numeric(15, 2), default=0)
    payment_method = Column(String(10))  # CHECK, EFTPS, ONLINE
    payment_confirmation = Column(String(20))
    payment_penalty = Column(Numeric(15, 2), default=0)
    payment_interest = Column(Numeric(15, 2), default=0)
...
class IrsFiscalCloseRec(Base):
    ...
    close_total_income = Column(Numeric(15, 2), default=0)
    close_total_expenses = Column(Numeric(15, 2), default=0)
    close_net_income = Column(Numeric(15, 2), default=0)
    close_depreciation_taken = Column(Numeric(15, 2), default=0)
    close_section179_deduction = Column(Numeric(15, 2), default=0)
    close_bonus_depreciation = Column(Numeric(15, 2), default=0)
    close_carryforward_losses = Column(Numeric(15, 2), default=0)
    close_carryforward_credits = Column(Numeric(15, 2), default=0)
...
class IrsDepreciationRec(Base):
    ...
    depreciation_cost = Column(Numeric(15, 2), nullable=False)
    ...
    depreciation_section179_amount = Column(Numeric(15, 2), default=0)
    depreciation_bonus_amount = Column(Numeric(15, 2), default=0)
    depreciation_basis_for_depreciation = Column(Numeric(15, 2), nullable=False)
    depreciation_current_year = Column(Numeric(15, 2), default=0)
    depreciation_prior_years = Column(Numeric(15, 2), default=0)
    depreciation_accumulated = Column(Numeric(15, 2), default=0)
    depreciation_remaining_basis = Column(Numeric(15, 2), nullable=False)
    depreciation_disposed_date = Column(Integer)  # YYYYMMDD
    depreciation_disposal_amount = Column(Numeric(15, 2), default=0)
    depreciation_gain_loss = Column(Numeric(15, 2), default=0)
...
class IrsElectronicFileRec(Base):
    ...
    efile_return_id = Column(Integer, ForeignKey('acas.irs_tax_return_rec.return_id'), nullable=False, index=True)
